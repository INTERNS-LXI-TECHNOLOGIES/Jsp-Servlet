...
/**
 * REST controller for managing {@link com.lxisoft.inventory.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    public List<Product> getAllProducts(@RequestParam(required = false) String filter) {
        if ("stock-is-null".equals(filter)) {
            log.debug("REST request to get all Products where stock is null");
            return productService.findAllWhereStockIsNull();
        }
