                ...
                <div class="container">
                  ...
                  <div class="row mt-5">
                    ...
                    <div class="col-md-6 mb-5 mt-md-0 mt-5 white-text text-center text-md-left">
                      <h1 class="h1-responsive font-weight-bold wow fadeInLeft" data-wow-delay="0.3s">Create Contact now! </h1>
                      ...
                      <div class="card wow fadeInRight" data-wow-delay="0.3s">
                        <div class="card-body">
                          ...
                          <div class="md-form">
                            ...
                            <input type="text" id="form3" class="white-text form-control" name="Your First Name">
                            <label for="form3" class="active">Your First Name</label>
                          </div>
                          <div class="md-form">
                                <i class="fas fa-user prefix white-text active"></i>
                                <input type="text" id="form3" class="white-text form-control" name="Your Last Name">
                                <label for="form3" class="active">Your Last Name</label>
                              </div>
                              <div class="md-form">
                                    <i class="fas fa-phone prefix white-text active"></i>
                                    <input type="text" id="form3" class="white-text form-control" name="Phone Number">
                                    <label for="form3" class="active">Phone Number</label>
                                  </div>
                                  <div class="md-form">
                                        <i class="fas fa-mobile prefix white-text active"></i>
                                        <input type="text" id="form3" class="white-text form-control" name="Mobile Number">
                                        <label for="form3" class="active">Mobile Number</label>
                                      </div>
                          <div class="md-form">
