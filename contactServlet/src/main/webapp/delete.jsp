...
<%@ page import = "com.lxisoft.Contact.servlet.DeleteC"%>
...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
              <a class="nav-link" href="delete.jsp">delete
  ...
  <!-- Full Page Intro -->
  <div class="view full-page-intro" style="background-image: url('https://mdbootstrap.com/img/Photos/Others/images/48.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="col-md-6 col-xl-5 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- Form -->
                <form name="" action="deletec" method="post">
                  <!-- Heading -->
                  ...
                  <div class="md-form">
                    ...
                    <input type="text" id="form3" class="form-control" name="n">
