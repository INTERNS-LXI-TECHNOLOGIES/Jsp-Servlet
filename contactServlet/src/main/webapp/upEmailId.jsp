                ...
                <div class="container">
                  ...
                  <div class="row mt-5">
                    ...
                    <div class="col-md-6 mb-5 mt-md-0 mt-5 white-text text-center text-md-left">
                      <h1 class="h1-responsive font-weight-bold wow fadeInLeft" data-wow-delay="0.3s">Update Email Id </h1>
                    ...
                    <div class="col-md-6 col-xl-5 mb-4">
                      <!--Form-->
                      <form name="" action="email" method="post">
                      <div class="card wow fadeInRight" data-wow-delay="0.3s">
                        <div class="card-body">
                          ...
                          <div class="md-form">
                            ...
                            <input type="text" id="form3" class="white-text form-control" name="Email">
                            <label for="form3" class="active">Your Current Mail Id</label>
                          </div>
                          <div class="md-form">
                                <i class="fas fa-envelope prefix white-text active"></i>
                                <input type="text" id="form3" class="white-text form-control" name="Updated Mail">
                                <label for="form3" class="active">Enter Updated Mail Id</label>
                              </div>
