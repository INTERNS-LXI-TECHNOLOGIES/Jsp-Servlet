...
<%@ page import = "com.lxisoft.Contact.servlet.UpdateNm"%>
...
<body>
  ...
  <!-- Full Page Intro -->
  <div class="view full-page-intro" style="background-image: url('https://mdbootstrap.com/img/Photos/Others/images/82.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="col-md-6 col-xl-5 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- Form -->
                <form name="" action="updatename" method="post">
                  <!-- Heading -->
                  ...
                  <div class="md-form">
                    <i class="fas fa-user prefix grey-text"></i>
                    <input type="text" id="form2" class="form-control" name="new name">
                    <label for="form2">New Name</label>
                  </div>
