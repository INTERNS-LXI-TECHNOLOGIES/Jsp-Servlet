...
<%@ page import = "com.lxisoft.Contact.servlet.Addnum"%>
...
<body>
  ...
  <!-- Full Page Intro -->
  <div class="view full-page-intro" style="background-image: url('https://mdbootstrap.com/img/Photos/Others/images/101.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="col-md-6 col-xl-5 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- Form -->
                <form name="" action="addnumber" method="post">
                  <!-- Heading -->
                  ...
                  <div class="md-form">
                    ...
                    <input type="text" id="form3" class="form-control" name="nam">
                    <label for="form3">Name</label>
                  </div>
                  <div class="md-form">
                    <i class="fas fa-phone prefix grey-text"></i>
                    <input type="text" id="form2" class="form-control" name="num">
                    <label for="form2">Number</label>
                  </div>
