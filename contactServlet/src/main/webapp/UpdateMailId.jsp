...
<%@ page import = "com.lxisoft.Contact.servlet.UpdateEm"%>
...
<body>
  ...
  <!-- Full Page Intro -->
  <div class="view full-page-intro" style="background-image: url('https://mdbootstrap.com/img/Photos/Others/images/95.jpg'); background-repeat: no-repeat; background-size: cover;">
          ...
          <div class="col-md-6 col-xl-5 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- Form -->
                <form name="" action="updatem" method="post">
                  <!-- Heading -->
